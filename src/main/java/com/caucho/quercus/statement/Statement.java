...
abstract public class Statement {
	...
	final protected void rethrow(Throwable t) throws Throwable {
	...
	final protected <E extends Throwable> void rethrow(Throwable t, Class<E> cl)
		...
		if (!(rootCause instanceof QuercusExecutionException)) {
			...
			QuercusExecutionException quercusEx = new QuercusExecutionException(
					quercusExMessage.toString());
		...
		elements[len] = new StackTraceElement(className, functionName,
				fileName, lineNumber);
