...
abstract public class Value implements java.io.Serializable {
    ...
    public Value getCalledClass(Env env) {
        ...
        if (qClass != null) return env.createString(qClass.getName());
        else {
    ...
    public boolean eq(Value rValue) {
        if (rValue.isArray()) return false;
        else if (rValue.isObject()) {
            return rValue.eq(this);
        } else if (rValue.isBoolean()) return toBoolean() == rValue.toBoolean();
        else if (isLongConvertible() && rValue.isLongConvertible()) return toLong() == rValue.toLong();
        else if (isNumberConvertible() || rValue.isNumberConvertible()) return toDouble() == rValue.toDouble();
        else return toString().equals(rValue.toString());
    }
    ...
    public int cmp(Value rValue) {
        ...
        if (lVal instanceof StringValue && rVal instanceof NullValue) return ((StringValue) lVal).cmpString(StringValue.EMPTY);

        if (lVal instanceof NullValue && rVal instanceof StringValue) return StringValue.EMPTY.cmpString((StringValue) rVal);

        if (lVal instanceof StringValue && rVal instanceof StringValue) return ((StringValue) lVal).cmpString((StringValue) rVal);

        if (lVal instanceof NullValue || lVal instanceof BooleanValue || rVal instanceof NullValue
        ...
        if (lVal.isObject() && rVal.isObject()) return ((ObjectValue) lVal).cmpObject((ObjectValue) rVal);

        if ((lVal instanceof StringValue || lVal instanceof NumberValue || lVal instanceof ResourceValue)
            && (rVal instanceof StringValue || rVal instanceof NumberValue || rVal instanceof ResourceValue)) return NumberValue.compareNum(lVal,
                                                                                                                                            rVal);
    ...
    public Object toJavaObject(Env env, Class<?> type) {
        env.warning(L.l("Can't convert {0} to Java {1}", getClass().getName(), type.getName()));
    ...
    /**
     * Convert to a function argument value, e.g. for function foo($a) where $a is never assigned, but might be
     * modified, e.g. $a[3] = 9
     */
    ...
    /**
     * Convert to a function argument reference value, e.g. for function foo(&$a) where $a is used as a variable in the
     * function
     */
    ...
    /**
     * Convert to a function argument reference value, e.g. for function foo(&$a) where $a is never assigned in the
     * function
     */
    ...
    public Value toArgRef() {
        Env.getCurrent().warning(L.l("'{0}' is an invalid reference, because only "
                                     + "variables may be passed by reference.", this));
    ...
    /**
     * Converts to a Unicode string. For unicode.semantics=false, this will still return a StringValue. For
     * unicode.semantics=true, this will return a UnicodeStringValue.
     */
    ...
    public StringValue toBinaryValue(Env env) {
        ...
        /*
         * try { int length = 0; while (true) { bb.ensureCapacity(bb.getLength() + 256); int sublen =
         * is.read(bb.getBuffer(), bb.getOffset(), bb.getLength() - bb.getOffset()); if (sublen <= 0) return bb; else {
         * length += sublen; bb.setOffset(length); } } } catch (IOException e) { throw new QuercusException(e); }
         */
    }
    ...
    public Value call(Env env, Value[] args) {
        ...
        if (call != null) return call.call(env, args);
        else return env.warning(L.l("{0} is not a valid function", this));
    }
    ...
    public Value callRef(Env env, Value[] args) {
        ...
        if (fun != null) return fun.callRef(env, args);
        else return env.warning(L.l("{0} is not a valid function", this));
    }
    ...
    public Value callCopy(Env env, Value[] args) {
        ...
        if (fun != null) return fun.callCopy(env, args);
        else return env.warning(L.l("{0} is not a valid function", this));
    }
    ...
    public Value callMethod(Env env, StringValue methodName, int hash, Value[] args) {
        if (isNull()) {
            return env.error(L.l("Method call '{0}' is not allowed for a null value.", methodName));
        } else {
    ...
    public final Value callMethod(Env env, StringValue methodName, Value a1, Value a2) {
        ...
        return callMethod(env, methodName, hash, a1, a2);
    }
    ...
    public final Value callMethodRef(Env env, StringValue methodName, Value a1, Value a2) {
        ...
        return callMethodRef(env, methodName, hash, a1, a2);
    }
    ...
    public final Value callMethod(Env env, StringValue methodName, Value a1, Value a2, Value a3) {
        ...
        return callMethod(env, methodName, hash, a1, a2, a3);
    }
    ...
    public final Value callMethodRef(Env env, StringValue methodName, Value a1, Value a2, Value a3) {
        ...
        return callMethodRef(env, methodName, hash, a1, a2, a3);
    }
    ...
    public Value callMethod(Env env, StringValue methodName, int hash, Value a1, Value a2, Value a3, Value a4) {
        return callMethod(env, methodName, hash, new Value[] { a1, a2, a3, a4 });
    }
    ...
    public final Value callMethod(Env env, StringValue methodName, Value a1, Value a2, Value a3, Value a4) {
        ...
        return callMethod(env, methodName, hash, a1, a2, a3, a4);
    }
    ...
    public Value callMethodRef(Env env, StringValue methodName, int hash, Value a1, Value a2, Value a3, Value a4) {
        return callMethodRef(env, methodName, hash, new Value[] { a1, a2, a3, a4 });
    }
    ...
    public final Value callMethodRef(Env env, StringValue methodName, Value a1, Value a2, Value a3, Value a4) {
        ...
        return callMethodRef(env, methodName, hash, a1, a2, a3, a4);
    }
    ...
    public Value callMethod(Env env, StringValue methodName, int hash, Value a1, Value a2, Value a3, Value a4, Value a5) {
        return callMethod(env, methodName, hash, new Value[] { a1, a2, a3, a4, a5 });
    }
    ...
    public final Value callMethod(Env env, StringValue methodName, Value a1, Value a2, Value a3, Value a4, Value a5) {
        ...
        return callMethod(env, methodName, hash, a1, a2, a3, a4, a5);
    }
    ...
    public Value callMethodRef(Env env, StringValue methodName, int hash, Value a1, Value a2, Value a3, Value a4,
                               Value a5) {
        return callMethodRef(env, methodName, hash, new Value[] { a1, a2, a3, a4, a5 });
    }
    ...
    public final Value callMethodRef(Env env, StringValue methodName, Value a1, Value a2, Value a3, Value a4, Value a5) {
        ...
        return callMethodRef(env, methodName, hash, a1, a2, a3, a4, a5);
    }
    ...
    public Value add(Value rValue) {
        if (getValueType().isLongAdd() && rValue.getValueType().isLongAdd()) return LongValue.create(toLong()
                                                                                                     + rValue.toLong());
    ...
    public Value sub_rev(long lLong) {
        if (getValueType().isLongAdd()) return LongValue.create(lLong - toLong());
        else return new DoubleValue(lLong - toDouble());
    }
    ...
    public Value mul(Value rValue) {
        if (getValueType().isLongAdd() && rValue.getValueType().isLongAdd()) return LongValue.create(toLong()
                                                                                                     * rValue.toLong());
        else return new DoubleValue(toDouble() * rValue.toDouble());
    }
    ...
    public Value mul(long r) {
        if (isLongConvertible()) return LongValue.create(toLong() * r);
        else return new DoubleValue(toDouble() * r);
    }
    ...
    public Value div(Value rValue) {
        if (getValueType().isLongAdd() && rValue.getValueType().isLongAdd()) {
            ...
            if (r != 0 && l % r == 0) return LongValue.create(l / r);
            else return new DoubleValue(toDouble() / rValue.toDouble());
        } else return new DoubleValue(toDouble() / rValue.toDouble());
    }
     ...
     */
    public Value abs() {
        if (getValueType().isDoubleCmp()) return new DoubleValue(Math.abs(toDouble()));
        else return LongValue.create(Math.abs(toLong()));
    }
    ...
    /**
     * Returns an iterator for the field keys. The default implementation uses the Iterator returned by
     * {@link #getIterator(Env)}; derived classes may override and provide a more efficient implementation.
     */
    ...
    /**
     * Returns an iterator for the field values. The default implementation uses the Iterator returned by
     * {@link #getIterator(Env)}; derived classes may override and provide a more efficient implementation.
     */
    ...
    public Var getVar(Value index) {
        ...
        if (value.isVar()) return (Var) value;
    ...
    public Value getObject(Env env, Value index) {
        ...
        if (var.isset()) return var.toValue();
        else {
    ...
    /**
     * Sets the array value, returning the new array, e.g. to handle string update ($a[0] = 'A'). Creates an array
     * automatically if necessary.
     */
    public Value append(Value index, Value value) {
        Value array = toAutoArray();

        if (array.isArray()) return array.append(index, value);
        else return array;
    }
    ...
    /**
     * Takes the values of this array, unmarshalls them to objects of type <i>elementType</i>, and puts them in a java
     * array.
     */
    ...
    public final void varDump(Env env, WriteStream out, int depth, IdentityHashMap<Value, String> valueSet)
                                                                                                           throws IOException {
    ...
    protected void varDumpImpl(Env env, WriteStream out, int depth, IdentityHashMap<Value, String> valueSet)
                                                                                                            throws IOException {
        out.print("resource(" + toString() + ")");
    }

    public final void printR(Env env, WriteStream out, int depth, IdentityHashMap<Value, String> valueSet)
                                                                                                          throws IOException {
        if (valueSet.get(this) != null) {
            out.print("*recursion*");
            return;
    ...
    protected void printRImpl(Env env, WriteStream out, int depth, IdentityHashMap<Value, String> valueSet)
                                                                                                           throws IOException {
        out.print(toString());
    }
