...
public class L10N {
    ...
    private static final HashMap<String, Properties> _l10nMap = new HashMap<String, Properties>();
    ...
    public String l(String msg, Object o1, Object o2, Object o3, Object o4, Object o5) {
        msg = getTranslated(msg);
    ...
    public String l(String msg, Object o1, Object o2, Object o3, Object o4, Object o5, Object o6) {
        msg = getTranslated(msg);
    ...
    public static String fillMessage(String msg, Object... objects) {
        return fillMessage(null, msg, objects);
    }

    public static String fillMessage(Properties stringMap, String msg, Object... objects) {
        StringBuilder cb = new StringBuilder();
        ...
        while (i < length) {
            ...
            if (ch != '{' || i + 2 >= length) {
                ...
                if (ch == '{') {
                    ...
                    if (value != null && (value instanceof Object[])) cb.append(Arrays.asList((Object[]) value));
                    else cb.append(objects[index]);
    ...
    private static int parseString(String msg, int i, StringBuilder sb, Properties stringMap) {
    ...
    private Properties getMessageMap() {
        ...
        if (Boolean.FALSE.equals(_isMessageFileAvailable)) return null;
    ...
    private Properties getStringMap() {
        ...
        if (Boolean.FALSE.equals(_isStringFileAvailable)) return null;
